...
TARGET	= vactrackerd
HEADERS= server.h client.h region.h regionYear.h user.h deposit.h withdrawal.h
HEADERS+= parse.h depositparser.h withdrawalparser.h userparser.h regionyearparser.h regionparser.h
SOURCES= main.cpp server.cpp client.cpp region.cpp regionYear.cpp user.cpp deposit.cpp withdrawal.cpp
